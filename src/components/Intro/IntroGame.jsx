  ...
  return (
    <div className="intro-game">
      <div className="background">
        <img src="/images/nubes-2.webp" alt="nubes" className="clouds clouds-two"/>
        <img src="/images/nubes.webp" alt="nubes" className="clouds clouds-one"/>
      </div>
      <div className="characters-container">
        <div className="characters">
          <img src="/images/piccolo_bt3.webp" className="picoro"/>
          <img src="/images/vegeta_bt3.webp" className="vegeta"/>
          <img src="/images/trunks_bt3.webp" className="trunks"/>
          <img src="/images/gohan_adult_bt3.webp" className="gohan"/>
          <img src="/images/goten_bt3.webp" className="goten"/>
          <img src="/images/goku_bt3.webp" className="goku"/>
          <img src="/images/logo.webp" className="logo-budokai"/>  
          <img src="/images/esfera.webp" className="esfera"/>  
        </div>
      </div>
      <div className="menu">
        { start === false && 
          <div className="press-start-container">
            ...
            <img src="/images/press-start.webp" className="press-start"/>  
          </div>
        }
